                ...
                <div className="w-full flex flex-col gap-4 items-center justify-center mb-20 p-5 text-white mt-10">
                    ...
                    <div className="md:flex gap-10 px-10 justify-center items-center w-[80vw] mt-20 ">
                        ...
                        <div className='md:w-[50%] rounded-md overflow-hidden py-10 md:py-0'>
                             <video className='hover:scale-150 duration-500' muted loop autoPlay src="src/assets/brain space.mp4"></video>
                        </div>                   
                    </div>

                    <div className="md:flex gap-10 px-10 justify-center items-center w-[80vw] mt-20 ">
                        <div className='md:w-[50%] rounded-md overflow-hidden py-10 md:py-0'>
                             <video className='hover:scale-150 duration-500' muted loop autoPlay src="src\assets\Elastic.mp4"></video>
                        </div>                   
                        <div className="md:flex flex-col gap-5">  
                    ...
                    <div className="md:flex gap-10 px-10 justify-center items-center w-[80vw] mt-20 ">
                        ...
                        <div className='md:w-[50%] rounded-md overflow-hidden py-10 md:py-0'>
                             <video className='hover:scale-150 duration-500' muted loop autoPlay src="src/assets/duo.mp4"></video>
                        </div>                   
                    </div>
